...
//
//*****************************************************************************
enum	EVitaTextureFormat
{
	VitaTexFmt_5650	= GU_PSM_5650,
	VitaTexFmt_5551	= GU_PSM_5551,
	VitaTexFmt_4444	= GU_PSM_4444,
	VitaTexFmt_8888	= GU_PSM_8888,
	VitaTexFmt_T4	= GU_PSM_T4,
	VitaTexFmt_T8	= GU_PSM_T8,
	VitaTexFmt_T16	= GU_PSM_T16,
	VitaTexFmt_T32	= GU_PSM_T32,
	VitaTexFmt_DXT1	= GU_PSM_DXT1,
	VitaTexFmt_DXT3	= GU_PSM_DXT3,
	VitaTexFmt_DXT5	= GU_PSM_DXT5,
};

//*****************************************************************************
//
//*****************************************************************************
EVitaTextureFormat	GetVitaTextureFormat( ETextureFormat texture_format )
{
	switch( texture_format )
	{
	case TexFmt_5650:		return VitaTexFmt_5650;
	case TexFmt_5551:		return VitaTexFmt_5551;
	case TexFmt_4444:		return VitaTexFmt_4444;
	case TexFmt_8888:		return VitaTexFmt_8888;

	case TexFmt_CI4_8888:	return VitaTexFmt_T4;
	case TexFmt_CI8_8888:	return VitaTexFmt_T8;
	}

#ifdef DAEDALUS_DEBUG_CONSOLE
	DAEDALUS_ERROR( "Unhandled texture format" );
#endif
	return VitaTexFmt_8888;
}
...
void	CNativeTexture::InstallTexture() const
{
	...
	{
		EVitaTextureFormat	psp_texture_format( GetVitaTextureFormat( mTextureFormat ) );
