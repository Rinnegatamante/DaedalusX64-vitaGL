...
AudioHLEInstruction NAudio_BK[0x20] =
{
    SPNOOP     ,ADPCM3    ,CLEARBUFF3,ENVMIXER3 ,LOADBUFF3 ,RESAMPLE3  ,SAVEBUFF3  ,UNKNOWN    ,
    UNKNOWN    ,SETVOL3   ,DMEMMOVE3 ,LOADADPCM3,MIXER3    ,INTERLEAVE3,NAUDIO_02B0,SETLOOP3   ,
    SPNOOP     ,SPNOOP    ,SPNOOP    ,SPNOOP    ,SPNOOP    ,SPNOOP     ,SPNOOP     ,SPNOOP     ,
...
AudioHLEInstruction NAudio_DK[0x20] =
{
    SPNOOP     ,ADPCM3    ,CLEARBUFF3,ENVMIXER3 ,LOADBUFF3 ,RESAMPLE3  ,SAVEBUFF3  ,MIXER3     ,
    MIXER3     ,SETVOL3   ,DMEMMOVE3 ,LOADADPCM3,MIXER3    ,INTERLEAVE3,NAUDIO_02B0,SETLOOP3   ,
    SPNOOP     ,SPNOOP    ,SPNOOP    ,SPNOOP    ,SPNOOP    ,SPNOOP     ,SPNOOP     ,SPNOOP     ,
    SPNOOP     ,SPNOOP    ,SPNOOP    ,SPNOOP    ,SPNOOP    ,SPNOOP     ,SPNOOP     ,SPNOOP
};
