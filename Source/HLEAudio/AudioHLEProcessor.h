...
public:
	ALIGNED_TYPE(u8, Buffer[N64_AUDIO_BUFF], 16);	// Seems excesively large? 0x1000 should be enough, but will require to make many changes, ex update the bitfields 
	u16		ADPCMTable[0x88];
