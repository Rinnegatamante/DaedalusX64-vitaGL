...
{
	ThreadHandle	thid( ::sceKernelCreateThread( name, StartThreadFunc, gThreadPriorities[TP_NORMAL], 0x10000, 0, 0, nullptr ) );
...
{
	int stat;
	int ret = ::sceKernelWaitThreadEnd(handle, &stat, (SceUInt*)&timeout);
