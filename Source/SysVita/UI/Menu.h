...
#define FOREACH_STR(FUNC) \
	...
	FUNC(STR_CONTINUE) \
	FUNC(STR_MENU_SRGB) \
	FUNC(STR_MENU_DYNAREC_INTEGER_OPT) \
	FUNC(STR_MENU_DYNAREC_FPU_CMP_OPT) \
	FUNC(STR_MENU_DYNAREC_FPU_REG_OPT) \
	FUNC(STR_MENU_DYNAREC_CTC1_OPT) \
	FUNC(STR_MENU_DYNAREC_SMC_OPT)
